...
# EngMaster IIUC — GEEL-1106 / UREL-1106 Advanced English Master Platform
...
├── Master_Notes/      # 16 Compiled textbook chapter notes (Markdown)
├── GEEL_1106_Complete_Exam_Preparation_Package.md # Consolidated master study guide
├── README.md          # Master GitHub repository overview
└── .gitignore         # Ignores temporary scratch scripts and virtual environments
```
...
1. Open the [`website/`](website/) folder on your computer.
